...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBottomLayout = (FrameLayout) findViewById(R.id.bottom_toolbar);
        mButtonBack = (TextView) findViewById(R.id.button_back);
        mButtonApply = (TextView) findViewById(R.id.button_apply);
        mButtonFinish = findViewById(R.id.text_finish);
        ...
        mPager.post(new Runnable() {
            @Override
            public void run() {
                mToolbar.setTitle((mPreviousPos + 1) + "/" + mAdapter.getCount());
            }
        });
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_back) {
            onBackPressed();
        } else if (v.getId() == R.id.button_apply || v.getId() == R.id.text_finish) {
            sendBackResult(true);
            finish();
        }
    }
    ...
    public void onPageSelected(int position) {
        mToolbar.setTitle((position + 1) + "/" + mAdapter.getCount());
    ...
    private void updateApplyButton() {
        ...
        if (selectedCount == 0) {
            ...
            mButtonFinish.setText(R.string.button_sure_default);
            ...
            mButtonFinish.setText(getString(R.string.button_sure, selectedCount, mSpec.maxSelectable));
        }
