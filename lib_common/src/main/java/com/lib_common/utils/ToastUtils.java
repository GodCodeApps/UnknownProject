...
public final class ToastUtils {
     ...
     * @param content
     */
    public static void showFinishToast(String content){
        setView(R.layout.finish_toast);
        ((ImageView)getView().findViewById(R.id.iv_icon)).setImageDrawable(ContextCompat.getDrawable(Utils.getContext(),R.mipmap.finish_icon));
        ((TextView)getView().findViewById(R.id.tv_msg)).setText(content);
    ...
    public static void showFailToast(String content){
        setView(R.layout.finish_toast);
        ((ImageView)getView().findViewById(R.id.iv_icon)).setImageDrawable(ContextCompat.getDrawable(Utils.getContext(),R.mipmap.fail_icon));
        ((TextView)getView().findViewById(R.id.tv_msg)).setText(content);
        setGravity(Gravity.CENTER,0,0);
        showCustomLongSafe();
    }
    ...
    public static void showDefaultToast(String content){
        setView(R.layout.default_toast);
        ((TextView)getView().findViewById(R.id.tv_msg)).setText(content);
        setGravity(Gravity.CENTER,0,0);
        showCustomLongSafe();
    }
     ...
     * @param content
     */
    public static void showDefaultBottomToast(String content){
        setView(R.layout.default_toast);
        ((TextView)getView().findViewById(R.id.tv_msg)).setText(content);
        setGravity(Gravity.BOTTOM,0,Utils.getContext().getResources().getDimensionPixelSize(R.dimen.sm_px_80));
        showCustomShortSafe();
    }
}