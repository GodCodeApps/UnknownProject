...
//            float dimension = getResources().getDimension(R.dimen.x65);
//            float dxH = getResources().getDisplayMetrics().heightPixels - dimension - getResources().getDimension(R.dimen.y510);
//            mCropRect.set(0, dxH,
//                    getResources().getDisplayMetrics().widthPixels, getResources().getDimension(R.dimen.y510));
//
//        }

        float dimension = getResources().getDimension(R.dimen.sm_px_70);
        float dxH = getResources().getDisplayMetrics().heightPixels - dimension - getResources().getDimension(R.dimen.sm_px_510);
        mCropRect.set(0, dxH,
                getResources().getDisplayMetrics().widthPixels, getResources().getDimension(R.dimen.sm_px_510));
