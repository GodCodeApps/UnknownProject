package com.lib_common.widget.crop;
...
////            float dimension = getResources().getDimension(R.dimen.x61);
////            mCropViewRect.set(0, dimension,
////                    getResources().getDisplayMetrics().widthPixels,getResources().getDisplayMetrics().heightPixels-dimension);
//
//
//        }
        float dimension = getResources().getDimension(R.dimen.sm_px_122);
        float height = getResources().getDisplayMetrics().widthPixels-2*getResources().getDimension(R.dimen.sm_px_40);
        float dxH = getResources().getDisplayMetrics().heightPixels - dimension - height;
        mCropViewRect.set(getResources().getDimension(R.dimen.sm_px_40), dimension,
                getResources().getDisplayMetrics().widthPixels-getResources().getDimension(R.dimen.sm_px_40), dimension+height);
        mGridPoints = null;
        mCircularPath.reset();
    ...
    private void initCropFrameStyle(@NonNull TypedArray a) {
        int cropFrameStrokeSize = a.getDimensionPixelSize(R.styleable.ucrop_UCropView_ucrop_frame_stroke_size,
                getResources().getDimensionPixelSize(R.dimen.sm_px_1));
        ...
        mCropFramePaint.setAntiAlias(true);
        mCropFramePaint.setPathEffect ( new DashPathEffect( new float [ ] { 5, 5 }, 0 ) ) ;
    }
