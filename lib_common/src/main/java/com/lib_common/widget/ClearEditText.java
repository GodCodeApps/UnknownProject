...
public class ClearEditText extends EditText implements
    ...
    public void setmLintener(OnTextChangeListener mLintener) {
        this.mLintener = mLintener;
    }

    public OnTextChangeListener mLintener;
...
//          throw new NullPointerException("You can add drawableRight attribute in XML");
            mClearDrawable = getResources().getDrawable(R.mipmap.default_head);
        }
    ...
    public void onTextChanged(CharSequence s, int start, int count,
        ...
        if(null!=mLintener){
            mLintener.onTextChanged(s,start,count,after);
        }
    }
