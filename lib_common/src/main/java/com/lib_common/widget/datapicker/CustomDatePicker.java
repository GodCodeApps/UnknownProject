package com.lib_common.widget.datapicker;
...
public class CustomDatePicker {
    ...
    public CustomDatePicker(Context context, ResultHandler resultHandler, String startDate, String endDate,int style) {
    ...
    private void initDialog(int style) {
        if (datePickerDialog == null) {
            datePickerDialog = new Dialog(context, style);
