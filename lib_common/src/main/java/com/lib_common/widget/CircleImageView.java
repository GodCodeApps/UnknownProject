...
public class CircleImageView extends ImageView {
    ...
    private boolean mBorderPadding;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderPadding=a.getBoolean(R.styleable.CircleImageView_civ_border_padding,false);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float temp=mDrawableRadius;
        if(mBorderPadding){
            temp=mDrawableRadius-10;
        }
        if (mCircleBackgroundColor != Color.TRANSPARENT) {
            canvas.drawCircle(mDrawableRect.centerX(), mDrawableRect.centerY(),temp , mCircleBackgroundPaint);
        }
        canvas.drawCircle(mDrawableRect.centerX(), mDrawableRect.centerY(), temp, mBitmapPaint);
        if (mBorderWidth > 0) {
    ...
    public void setBorderPaddingState(boolean state){
        mBorderPadding=state;
    }
